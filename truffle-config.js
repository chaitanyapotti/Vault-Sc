...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: new HDWalletProvider(mnemonic, `https://ropsten.infura.io/v3/${infuraKey}`, 0, 20),
      network_id: "1",
      gas: 6900000,
      gasPrice: 10000000000
    },
    main: {
      provider: new HDWalletProvider(mnemonic, `https://mainnet.infura.io/v3/${infuraKey}`, 0, 20),
      network_id: "0",
      gas: 6900000,
      gasPrice: 1000000000
    }
